 ...
 * @author  Alain Schlesser <alain.schlesser@gmail.com>
 */
class RemoveVendorFolder extends AbstractTask
{
    ...
    {
        $vendorFolder = $this->getConfigKey('Folders', 'vendor');
        try {
            $filesystem = new Filesystem();
            $filesystem->removeDirectory($vendorFolder);
